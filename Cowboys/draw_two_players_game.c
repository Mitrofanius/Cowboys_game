...
void draw_two_players_game(unsigned char *parlcd_mem_base, unsigned short *frame_buffer, font_descriptor_t *font_descriptor, game_map_t *game_map)
{
    ...
    draw_cowboy(parlcd_mem_base, frame_buffer, font_descriptor, &(game_map->cowboy_left), 8);
    draw_cowboy(parlcd_mem_base, frame_buffer, font_descriptor, &(game_map->cowboy_right), 8);
